...
public final class CryptoManager implements TokenSupplier
{
    ...
    public static final String
     JAR_JSS_VERSION     = "JSS_VERSION = JSS_3_1_2_6_RTM";
     public static final String
     JAR_JDK_VERSION     = "JDK_VERSION = JDK 1.4.0";
     public static final String
     JAR_NSS_VERSION     = "NSS_VERSION = NSS_3_3_7_RTM";
     public static final String
     JAR_DBM_VERSION     = "DBM_VERSION = NSS_3_3_7_RTM";
     public static final String
     JAR_NSPR_VERSION    = "NSPR_VERSION = NSPRPUB_RELEASE_4_1_6_RTM";
     public static final String
     JAR_SECURITY_VERSION= "SECURITY_VERSION = SECURITY_3_3_7_RTM";
