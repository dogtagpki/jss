Summary: Network Security Services for Java v3
Name: NAME_REPLACE
...
%description
Network Security Services for Java v3 (JSS3) is a set of libraries designed
...
%package devel
Summary: Development Libraries for Network Security Services for Java v3
...
%description devel
Header files for doing development with Network Security Services for Java v3.
