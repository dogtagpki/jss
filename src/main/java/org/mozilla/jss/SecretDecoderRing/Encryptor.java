...
public class Encryptor {
     ...
     *         SecretDecoderRing.
     */
    public byte[] encrypt(byte[] plaintext) throws NotInitializedException,
        ...
        try {
            ...
            byte[] paddedPtext = org.mozilla.jss.crypto.Cipher.pad(
            ...
            //
            Encoding encoding = new Encoding(keyID, iv, alg.toOID(), rawCtext);
