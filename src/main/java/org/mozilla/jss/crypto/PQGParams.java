 ...
 *
 * <p>
 * It is necessary to call <code>CryptoManager.initialize</code> before
 * using this class.
 *
 */
public class PQGParams extends DSAParameterSpec {
     ...
     */
    private static native PQGParams generateNative(int keySize)
            throws java.security.InvalidParameterException,
            PQGParamGenException;
     ...
     * @see org.mozilla.jss.CryptoManager#initialize
     */
    public static PQGParams generate(int keySize, int seedBytes)
            throws java.security.InvalidParameterException,
            PQGParamGenException {
     ...
     * Does the actual work of generation, but does not verify.
     */
    private static native PQGParams generateNative(int keySize, int seedBytes)
            throws java.security.InvalidParameterException,
            PQGParamGenException;
