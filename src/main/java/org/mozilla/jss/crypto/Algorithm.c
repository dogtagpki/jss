...
JSS_AlgInfo JSS_AlgTable[NUM_ALGS] =
		...
		/* 20 */{ SEC_OID_PKCS5_PBE_WITH_SHA1_AND_DES_CBC, SEC_OID_TAG },
				/* 21 */{ SEC_OID_PKCS12_V2_PBE_WITH_SHA1_AND_128_BIT_RC4,
						SEC_OID_TAG },
				/* 22 */{ SEC_OID_PKCS12_V2_PBE_WITH_SHA1_AND_40_BIT_RC4,
						SEC_OID_TAG },
				/* 23 */{
				...
				/* 28 */{ SEC_OID_PKCS12_V2_PBE_WITH_SHA1_AND_128_BIT_RC2_CBC,
						SEC_OID_TAG },
				/* 29 */{ SEC_OID_PKCS12_V2_PBE_WITH_SHA1_AND_40_BIT_RC2_CBC,
						SEC_OID_TAG },
				...
				/* 56 */{ SEC_OID_ANSIX962_ECDSA_SIGNATURE_SPECIFIED_DIGEST,
						SEC_OID_TAG },
				...
				/* 77 */{ CKM_NSS_SP800_108_DOUBLE_PIPELINE_KDF_DERIVE_DATA,
						PK11_MECH },
 ...
 */
CK_MECHANISM_TYPE JSS_getPK11MechFromAlg(JNIEnv *env, jobject alg) {
	JSS_AlgInfo info;
 ...
 *      if none was found.
 */
SECOidTag JSS_getOidTagFromAlg(JNIEnv *env, jobject alg) {
	JSS_AlgInfo info;
 ...
 *      thrown.
 */
static jint getAlgIndex(JNIEnv *env, jobject alg) {
	jclass algClass;
	jint index = -1;
	jfieldID indexField;
	...
	indexField = (*env)->GetFieldID(env, algClass,
 ...
 */
static PRStatus getAlgInfo(JNIEnv *env, jobject alg, JSS_AlgInfo *info) {
	jint index;
...
Java_org_mozilla_jss_crypto_EncryptionAlgorithm_getIVLength(JNIEnv *env,
		jobject this) {
 ...
 */
CK_ULONG JSS_symkeyUsage[] = { CKA_ENCRYPT, /* 0 */
CKA_DECRYPT, /* 1 */
CKA_WRAP, /* 2 */
CKA_UNWRAP, /* 3 */
CKA_SIGN, /* 4 */
