...
public enum SSLVersion {
     ...
     * [1] - JDK name
     */
    SSL_2_0(new String[] { "SSL2", "SSLv2" }, SocketBase.SSL_LIBRARY_VERSION_2, 0x0002), SSL_3_0(
            new String[] { "SSL3", "SSLv3" }, SocketBase.SSL_LIBRARY_VERSION_3_0,
            0x0300), TLS_1_0(new String[] { "TLS1_0", "TLSv1" }, SocketBase.SSL_LIBRARY_VERSION_TLS_1_0,
                    0x0301), TLS_1_1(new String[] { "TLS1_1", "TLSv1.1" }, SocketBase.SSL_LIBRARY_VERSION_TLS_1_1,
                            0x0302), TLS_1_2(new String[] { "TLS1_2", "TLSv1.2" },
                                    SocketBase.SSL_LIBRARY_VERSION_TLS_1_2,
                                    0x0303), TLS_1_3(new String[] { "TLS1_3", "TLSv1.3" },
                                            SocketBase.SSL_LIBRARY_VERSION_TLS_1_3, 0x0304);
