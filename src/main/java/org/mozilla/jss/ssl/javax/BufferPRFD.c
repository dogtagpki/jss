...
static PRInt32 PRBufferRecv(PRFileDesc *fd, void *buf, PRInt32 amount,
		PRIntn flags, PRIntervalTime timeout) {
...
static PRStatus PRBufferGetSocketOption(PRFileDesc *fd,
...
static PRStatus PRBufferSetSocketOption(PRFileDesc *fd,
...
static const PRIOMethods PRIOBufferMethods = { PR_DESC_SOCKET_TCP,
		PRBufferClose, PRBufferRead, PRBufferWrite,
		(PRAvailableFN) invalidInternalCall,
		(PRAvailable64FN) invalidInternalCall, (PRFsyncFN) invalidInternalCall,
		(PRSeekFN) invalidInternalCall, (PRSeek64FN) invalidInternalCall,
		(PRFileInfoFN) invalidInternalCall,
		(PRFileInfo64FN) invalidInternalCall, (PRWritevFN) invalidInternalCall,
		(PRConnectFN) invalidInternalCall, (PRAcceptFN) invalidInternalCall,
		(PRBindFN) invalidInternalCall, (PRListenFN) invalidInternalCall,
		PRBufferShutdown, PRBufferRecv, PRBufferSend,
		(PRRecvfromFN) invalidInternalCall, (PRSendtoFN) invalidInternalCall,
		(PRPollFN) invalidInternalCall, (PRAcceptreadFN) invalidInternalCall,
		(PRTransmitfileFN) invalidInternalCall,
		(PRGetsocknameFN) invalidInternalCall, PRBufferGetPeerName,
		(PRReservedFN) invalidInternalCall, (PRReservedFN) invalidInternalCall,
		PRBufferGetSocketOption, PRBufferSetSocketOption,
