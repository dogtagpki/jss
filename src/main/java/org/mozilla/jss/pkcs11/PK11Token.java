...
public final class PK11Token implements CryptoToken {
    ...
    ////////////////////////////////////////////////////
    @Override
    public org.mozilla.jss.crypto.Signature getSignatureContext(SignatureAlgorithm algorithm)
    ...
    @Override
    public org.mozilla.jss.crypto.KeyPairGenerator getKeyPairGenerator(KeyPairAlgorithm algorithm)
            throws NoSuchAlgorithmException, TokenException {
        assert (algorithm != null);
