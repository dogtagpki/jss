...
final class Tunnel {
    ...
    private static class CryptoTunnel extends org.mozilla.jss.crypto.Tunnel {
        public static Signature constructSignature(SignatureAlgorithm alg, SignatureSpi engine) {
    ...
    static Signature constructSignature(SignatureAlgorithm alg, SignatureSpi engine) {
