...
public class EncryptedPrivateKeyInfo implements ASN1Value {
     ...
     */
    public static EncryptedPrivateKeyInfo createPBE(PBEAlgorithm keyGenAlg, Password password, byte[] salt,
            int iterationCount,
    ...
    public static EncryptedPrivateKeyInfo createPBES2(
        ...
        try {
            ...
            throw new RuntimeException(
                    "IllegalBlockSizeException in EncryptedContentInfo.createPBES2: " + e.getMessage(), e);
        } catch (BadPaddingException e) {
