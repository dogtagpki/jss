...
public class ContentInfo implements ASN1Value {
    ...
    public static OBJECT_IDENTIFIER SIGNED_AND_ENVELOPED_DATA = new OBJECT_IDENTIFIER(
            new long[] { 1, 2, 840, 113549, 1, 7, 4 });
     ...
     * <p>
     * If the contentType is <b>not</b> one of the six standard types,
