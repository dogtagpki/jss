...
JNIEXPORT jlong JNICALL
Java_org_mozilla_jss_nss_Buffer_ReadCapacity(JNIEnv *env, jclass clazz,
		jobject buf) {
	j_buffer *real_buf = NULL;
...
JNIEXPORT jlong JNICALL
Java_org_mozilla_jss_nss_Buffer_WriteCapacity(JNIEnv *env, jclass clazz,
		jobject buf) {
	j_buffer *real_buf = NULL;
...
JNIEXPORT jlong JNICALL
Java_org_mozilla_jss_nss_Buffer_Write(JNIEnv *env, jclass clazz, jobject buf,
		jbyteArray input) {
	j_buffer *real_buf = NULL;
...
JNIEXPORT jint JNICALL
Java_org_mozilla_jss_nss_Buffer_Put(JNIEnv *env, jclass clazz, jobject buf,
		jbyte input) {
	j_buffer *real_buf = NULL;
