...
JNIEXPORT int JNICALL
Java_org_mozilla_jss_nss_SECErrors_getExpiredCertificate(JNIEnv *env,
		jclass clazz) {
...
JNIEXPORT int JNICALL
Java_org_mozilla_jss_nss_SECErrors_getRevokedCertificateOCSP(JNIEnv *env,
		jclass clazz) {
	return SEC_ERROR_REVOKED_CERTIFICATE_OCSP;
}

JNIEXPORT int JNICALL
Java_org_mozilla_jss_nss_SECErrors_getRevokedCertificate(JNIEnv *env,
		jclass clazz) {
