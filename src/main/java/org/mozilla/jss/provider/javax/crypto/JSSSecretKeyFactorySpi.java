...
public class JSSSecretKeyFactorySpi extends SecretKeyFactorySpi {
    ...
    private SecretKey generateKeyFromBits(byte[] bits, SymmetricKey.Type keyType)
    ...
    private static PBEKeyGenParams makePBEKeyGenParams(PBEKeySpec spec)
        ...
        try {
            ...
            Method getIterationMethod = specClass.getMethod("getIterationCount",
                    (java.lang.Class[]) null);

            byte[] salt = (byte[]) getSaltMethod.invoke(spec,
                    (java.lang.Object[]) null);

            Integer itCountObj = (Integer) getIterationMethod.invoke(spec,
                    (java.lang.Object[]) null);
