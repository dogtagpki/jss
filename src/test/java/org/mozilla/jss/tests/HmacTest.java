...
public class HmacTest {
    ...
    private static final String INTERNAL_KEY_STORAGE_TOKEN = new InitializationValues("")
            .getInternalKeyStorageTokenDescription().trim();
    ...
    private static void configureCrypto(String[] args)
        ...
        CryptoToken cryptoToken = cryptoManager.getTokenByName(INTERNAL_KEY_STORAGE_TOKEN);
