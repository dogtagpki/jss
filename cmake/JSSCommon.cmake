...
macro(jss_build_java)
    ...
    add_custom_command(
        ...
        DEPENDS ${JAVA_TEST_SOURCES} generate_build_jar
    )

    add_custom_target(
        generate_tests_java ALL
...
macro(jss_build_jars)
    ...
    add_custom_target(
        generate_jar ALL
        DEPENDS "${JSS_JAR_PATH}" generate_tests_jar
    )
endmacro()
